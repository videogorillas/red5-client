...
public class ClientBroadcastStream extends AbstractClientStream implements IClientBroadcastStream, IFilter, IPushableConsumer, IPipeConnectionListener, IEventDispatcher, IClientBroadcastStreamStatistics {
...
//        return RecordingListener.getRecordFile(scope, name);
        throw new IllegalStateException("getRecordFile not supported");
    }
